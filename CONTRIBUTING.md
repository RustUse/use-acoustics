...
RustUse/use-acoustics is intentionally small and focused. Contributions should keep the public API explicit, typed, and pragmatic.
...
- `use-acoustics` is the RustUse acoustics primitives crate, not a CLI and not a general automation layer.
